...
CREATE TABLE pre_checkout_form_steps (
  ...
  type TEXT NOT NULL CHECK (type IN ('welcome_screen', 'statement', 'short_text', 'long_text', 'email', 'phone', 'number', 'date', 'single_choice', 'picture_choice', 'multiple_choice', 'dropdown', 'yes_no', 'rating', 'opinion_scale', 'nps', 'legal', 'end_screen')),
  title TEXT NOT NULL,
  description TEXT DEFAULT '',
