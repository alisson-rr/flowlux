-- =====================================================
-- FlowLux - Populate: Conversas e Mensagens WhatsApp (COM IDS REAIS)
-- User ID: 56ed5bf7-c7ca-4497-aaf7-b202483a0b7b
-- =====================================================

-- 1. Conversas com Instância 6b4edc06-445e-4284-9b41-2a65c4e64eb9 (comercial) - 3 conversas
-- =================================================================
...
-- 2. Conversa com Instância 80333498-f340-4094-b5e9-b159cd1a46bb (suporte) - 1 conversa
-- =================================================================
...
-- ✅ 3 Conversas com instancia comercial (6b4edc06-445e-4284-9b41-2a65c4e64eb9):
...
-- 
-- ✅ 1 Conversa com instancia suporte (80333498-f340-4094-b5e9-b159cd1a46bb):
--    - Ana Oliveira (12 mensagens) - Suporte pós-venda
-- 
-- ✅ Total: 46 mensagens trocadas
-- ✅ Usando IDs reais dos leads e instâncias
-- ✅ Subqueries com LIMIT 1 para evitar erros
-- =====================================================
